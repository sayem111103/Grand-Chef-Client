...
const Footer = () => {
    return (
        <footer className='bg-[#222D38]'>
            ...
            <p className='flex items-center text-xs lg:text-lg text-white justify-center'>Copyright <FaRegCopyright className='text-xs lg:text-lg mx-1'></FaRegCopyright> 2022.All rights reserved by <span className='ml-1 uppercase text-amber-300'>Grand Chef.</span></p>
            </div>
        </footer>
    );
};
