                        ...
                        <div className='mx-auto w-[90%] lg:w-[unset]  mt-6 lg:mt-0' key={cd.id}>
                            <div className="lg:max-w-sm h-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div className="p-5">
                                    ...
                                    <p><span className='text-md font-bold'>Recipe : </span> {cd.numRecipes} items</p>
                                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400"><span className='text-md font-bold'>Experience : </span>{cd.yearsOfExperience} years</p>
                                    <div className='flex items-center justify-between'>
                                        <Link to={`/recipe/${cd.id}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            View Recipe
