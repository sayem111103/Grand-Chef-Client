        ...
        <>
            <section>
                <div className='mx-auto w-[95%] py-10'>
                    <form onSubmit={handleRegistration} className='w-[90%] lg:w-5/12 mx-auto border p-5 rounded'>
                        ...
                        <h4 className='text-center mt-3 text-sm lg:text-lg'>Already a Member? <Link to='/login' className='text-blue-500 underline decoration-solid'>Please Login Here</Link></h4>
                    </form>
                </div>
            </section>
        </>
